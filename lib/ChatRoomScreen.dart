...
class _ChatRoomScreenState extends State<ChatRoomScreen> {
  ...
  activeChatRoom() async {
    ...
    preferences.setString('activeRoomId', widget.chatRoomId);
  }
  ...
  void onSendMessage() async {
    if (messageTextController.text.isNotEmpty) {
      if (!isEditMessage) {
        ...
        print('message send');
          FireBaseFireStoreHelperClass.updateLastMessageTime(widget.chatRoomId,messageId,messageTextController.text,"text");
  ...
  Future uploadImage() async {
    ...
    if (status == 1) {
      ...
      FireBaseFireStoreHelperClass.updateLastMessageTime(widget.chatRoomId,fileName,imageUrl,"img");
      print(imageUrl);
    }
  }
                      ...
                      child: StreamBuilder<QuerySnapshot>(
                        ...
                        builder: (BuildContext context,
                          ...
                          if (snapshot.data != null) {
                            if (kDebugMode) {
                              print(
                                  'messages from cloud:${snapshot.data?.docs}');
                            }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SizedBox(
          width: size.width,
          height: size.height,
          child: Hero(tag: 'effect', child: CachedNetworkImage(imageUrl:imageUrl))),
    );
  }
}
